...
namespace Identity.API.Controllers
{
    ...
    public class ExternalController : Controller
    {
        ...
        public ExternalController(SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IIdentityServerInteractionService interaction, IClientStore clientStore, IEventService events, ILogger<ExternalController> logger)
        {
